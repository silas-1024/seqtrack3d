...
def local_env_settings():
    ...
    settings.network_path = '/media/lisuran/seqtrack_3d/output/test/networks'    # Where tracking networks are stored.
    ...
    settings.prj_dir = '/media/lisuran/seqtrack_3d'
    settings.result_plot_path = '/media/lisuran/seqtrack_3d/output/test/result_plots'
    settings.results_path = '/media/lisuran/seqtrack_3d/output/test/tracking_results'    # Where to store tracking results
    settings.satsot_path = '/media/pc-4090/9bd4d9e0-148f-4dd1-a9c6-1f4c9dff8e4e/datasets/satsot'
    settings.save_dir = '/media/lisuran/seqtrack_3d/output'
    settings.segmentation_path = '/media/lisuran/seqtrack_3d/output/test/segmentation_results'
