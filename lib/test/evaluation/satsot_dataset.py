...
class satsot_dataset(BaseDataset):
    """
    ...
    def __init__(self):
        ...
        self.base_path = os.path.join(self.env_settings.satsot_path)
    ...
    def _construct_sequence(self, sequence_name):
        ...
        return Sequence(sequence_name, frames_list, 'satsot_dataset', ground_truth_rect.reshape(-1, 4))
