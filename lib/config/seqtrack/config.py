...
cfg.MODEL.MOTION.HIDDEN_DIM = 256               # Hidden dim for motion encoder
...
cfg.TEST.EPOCH = 500
cfg.TEST.CHECKPOINT_YAML_NAME = ""
cfg.TEST.WINDOW = False # window penalty
cfg.TEST.NUM_TEMPLATES = 1
cfg.TEST.USE_KRSU = False
cfg.TEST.KRSU_MODE = "kalman_lite"
cfg.TEST.KRSU_CENTER_ONLY = True
cfg.TEST.KRSU_USE_LOGIT_CONF = True
cfg.TEST.KRSU_USE_AFFINE_VALID = True
cfg.TEST.KRSU_Q_SCALE = 1.0
cfg.TEST.KRSU_R_SCALE = 400.0
cfg.TEST.KRSU_BOOTSTRAP_Q = 400.0
cfg.TEST.KRSU_TARGET_Q_FLOOR_SCALE = 0.5
cfg.TEST.KRSU_MIN_HISTORY_FOR_PRIOR = 2
cfg.TEST.KRSU_AFFINE_INVALID_Q_PENALTY = 4.0
cfg.TEST.KRSU_MAX_UPDATE_PIXELS = 20
cfg.TEST.KRSU_DYNAMIC_CLIP = False
cfg.TEST.KRSU_MIN_R = 1e-4
cfg.TEST.KRSU_MIN_Q = 1e-4
cfg.TEST.KRSU_MIN_P = 1e-4
...
cfg.TEST.UPDATE_INTERVALS.SV248S_TEST = 10
cfg.TEST.UPDATE_INTERVALS.SATSOT = 10
cfg.TEST.UPDATE_INTERVALS.VISO = 10
...
cfg.TEST.UPDATE_THRESHOLD.SV248S_TEST = 0.475
