...
def create_default_local_file():
    ...
    default_settings = OrderedDict({
        ...
        'viso_train_dir':empty_str,
        'viso_val_dir':empty_str,
...
def create_default_local_file_ITP_train(workspace_dir, data_dir):
    ...
    default_settings = OrderedDict({
        ...
        'imagenetdet_dir': empty_str,
        'ecssd_dir': empty_str,
        'sv248s_train_dir': os.path.join(data_dir, 'sv248/train_sv'),
        'viso_train_dir': os.path.join(data_dir, 'viso_train'),
        'viso_val_dir': os.path.join(data_dir, 'viso_val'),
        'hkuis_dir': empty_str,
        'msra10k_dir': empty_str,
        'davis_dir': empty_str,
        'youtubevos_dir': empty_str,
